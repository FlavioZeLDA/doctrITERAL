...
def main():  
    ...
    # Pedar aquivo por aquivo
    #pasta = '/content/drive/MyDrive/ITERAL '
    #Saida= '/content/drive/MyDrive/ITERAL /DOCTR'
    pasta ='C:\\Users\\Flavio\\Desktop\\TITULOS\\DADOS_AMOSTRAS_TITULOS'
    Saida= 'C:\\Users\\Flavio\\Desktop\\TITULOS\\DOCTR_DADOS_AMOSTRAS_TITULOS'
    for diretorio, subpastas, arquivos in os.walk(pasta):

    
    
      for arquivo in arquivos:
        Arquivo=(os.path.join(os.path.realpath(diretorio), arquivo))
       
        subpastA=(re.findall(r'C:\\Users\\Flavio\\Desktop\\TITULOS\\DADOS_AMOSTRAS_TITULOS\\(.+?)\\', Arquivo))
        Saida=os.mkdir(Saida + "\\" + (subpastA[0]))
        
        
        Arquivo2=(os.path.join(os.path.realpath(Saida),s(subpastA[0])))
        Arquivo2=(os.path.join(os.path.realpath(Saida), arquivo))
        ...
        doc = DocumentFile.from_pdf(Arquivo)
        #print(doc)
        # Analyze
        result = model(doc)
        #result.show(doc)
        ...
        tmpdir = tempfile.mkdtemp(prefix="myapplication-")
